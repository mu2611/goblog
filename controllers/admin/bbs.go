...
//删除
func (this *BbsController) Delete() {
	id, _ := this.GetInt("id")
	post := models.Post{Id: id}
	if post.Read() == nil {
		post.Delete()
...
//上传文件
func (this *BbsController) Upload() {
